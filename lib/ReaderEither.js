 ...
 * @since 2.0.0
 */
exports.fromEither = Reader_1.reader.of;
/**
 * @since 2.0.0
 */
...
function filterOrElse(predicate, onFalse) {
    return function (ma) { return Reader_1.reader.map(ma, E.filterOrElse(predicate, onFalse)); };
}
...
var _a = pipeable_1.pipeable(exports.readerEither), alt = _a.alt, ap = _a.ap, apFirst = _a.apFirst, apSecond = _a.apSecond, bimap = _a.bimap, chain = _a.chain, chainFirst = _a.chainFirst, flatten = _a.flatten, map = _a.map, mapLeft = _a.mapLeft;
exports.alt = alt;
exports.ap = ap;
