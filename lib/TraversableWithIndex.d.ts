...
export interface TraverseWithIndex2<T extends URIS2, I> {
    <F extends URIS3>(F: Applicative3<F>): <FU, FL, A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind3<F, FU, FL, B>) => Kind3<F, FU, FL, Kind2<T, FL, B>>;
    <F extends URIS3, FU, FL>(F: Applicative3C<F, FU, FL>): <A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind3<F, FU, FL, B>) => Kind3<F, FU, FL, Kind2<T, FL, B>>;
    <F extends URIS2>(F: Applicative2<F>): <FL, A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind2<F, FL, B>) => Kind2<F, FL, Kind2<T, FL, B>>;
    <F extends URIS2, FL>(F: Applicative2C<F, FL>): <A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind2<F, FL, B>) => Kind2<F, FL, Kind2<T, FL, B>>;
    <F extends URIS>(F: Applicative1<F>): <FL, A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind<F, B>) => Kind<F, Kind2<T, FL, B>>;
...
export interface TraverseWithIndex2C<T extends URIS2, I, FL> {
    <F extends URIS3>(F: Applicative3<F>): <FU, A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind3<F, FU, FL, B>) => Kind3<F, FU, FL, Kind2<T, FL, B>>;
    <F extends URIS3, FU>(F: Applicative3C<F, FU, FL>): <A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind3<F, FU, FL, B>) => Kind3<F, FU, FL, Kind2<T, FL, B>>;
    <F extends URIS2>(F: Applicative2<F>): <A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind2<F, FL, B>) => Kind2<F, FL, Kind2<T, FL, B>>;
    <F extends URIS2>(F: Applicative2C<F, FL>): <A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind2<F, FL, B>) => Kind2<F, FL, Kind2<T, FL, B>>;
    <F extends URIS>(F: Applicative1<F>): <A, B>(ta: Kind2<T, FL, A>, f: (i: I, a: A) => Kind<F, B>) => Kind<F, Kind2<T, FL, B>>;
